        ...
        p.render = function (time, suppressEvents, force) {
            ...
            if (callback) if (!self._gc || force) { //check gc because there's a chance that kill() could be called in an onUpdate
                ...
                if (!suppressEvents && self.vars[callback]) {
                    console.log('reverse render self complete ', suppressEvents, self)
        ...
        */
        ...
        p.add = function (value, position, align, stagger) {
            ...
            if (self._gc || self._time === self._duration) if (!self._paused) if (self._duration < self.duration()) {
                ...
                while (tl._timeline) {
                    if (beforeRawTime && tl.smoothChildTiming) {
        ...
        p.render = function (time, suppressEvents, force) {
            // console.log('suppressEvents ', suppressEvents)
            if (this._gc) {
...
(function (window, moduleName) {
    ...
    p.duration = function (value) {
        ...
        if (this.smoothChildTiming) if (this._time > 0) if (this._time < this._duration) if (value !== 0) {
    ...
    p.timeScale = function (value) {
        ...
        var pauseTime, t;
        value = value || _tinyNum; //can't allow zero because it'll throw the math off
        if (this._timeline && this.smoothChildTiming) {
    ...
    p.reversed = function (value) {
        ...
        if (value != this._reversed) {
            ...
            this.totalTime(((this._timeline && !this.smoothChildTiming) ? this.totalDuration() - this._totalTime : this._totalTime), true);
        }
        return this;
    };
